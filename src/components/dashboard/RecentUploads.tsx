...
const uploads = [
  { file: "2024년 7월 급여대장.xlsx", status: "completed", rows: 152, user: "급여담당자A", time: "5분 전" },
  { file: "2024년 6월 보너스.csv", status: "completed", rows: 50, user: "급여담당자B", time: "2시간 전" },
  { file: "2024년 6월 급여대장_v2.xlsx", status: "failed", rows: 148, user: "급여담당자A", time: "1일 전" },
  { file: "2024년 5월 급여대장.xlsx", status: "completed", rows: 145, user: "급여담당자A", time: "1달 전" },
  { file: "임시_테스트_데이터.csv", status: "warning", rows: 5, user: "개발자", time: "1달 전" },
];
